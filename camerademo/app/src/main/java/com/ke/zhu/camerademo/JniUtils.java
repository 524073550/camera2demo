...
public class JniUtils {
     ...
     * @param dst    输出数据
     */
    public static native void nv21ToI420(byte[] srcY, byte[] srcVU, int width, int height, byte[] dst);
     ...
     * @param dst    输出数据
     */
    public static native void I420Rotate(byte[] src, int width, int height, byte[] dst,int degree,boolean isMirror);
